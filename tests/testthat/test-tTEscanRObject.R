test_that("The tTEscanR object is correctly generated", {
  ...
  expect_no_error(Create_tTEscanR_Object(counts = list(mRNA_data), assay = "mRNA", meta.data = cell_types, meta.data.ids = "cell.types"))
...
test_that("The tTEscanR object is correctly updated", {
  ...
  expect_no_error(Update_tTEscanR_Object(object = tTEobject, counts = list(mRNA_data), assay = "mRNA",  overwrite.assay = TRUE)) # inconsistencies list-single
