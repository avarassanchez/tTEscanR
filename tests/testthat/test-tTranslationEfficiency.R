test_that("The different modes to compute the theoretical translation efficiency scores", {
  ...
  tTEscanR_obj <- Create_tTEscanR_Object(counts = list(mRNA = subset_mRNA_data, tRNA = subset_tRNA_data),
                                         meta.data = list(ConditionsLabels = metadata, CorrectionFactor = "tissue"))

  # CASE 1
  # assays not present in the object
