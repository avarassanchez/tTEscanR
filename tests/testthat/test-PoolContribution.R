...
test_that("Checking the codon pool contribution", {
  ...
  tTEscanR_obj <- Update_tTEscanR_Object(object = tTEscanR_obj, meta.data = list(default_tTEscanR_metadata, "tissue"), meta.data.ids = list("ConditionsLabels", "CorrectionFactor"))
...
test_that("Input validation for ShowPoolContribution catches bad arguments", {
  ...
  tTEscanR_obj <- Create_tTEscanR_Object(counts = mRNA_data_test, assay = "mRNA")
  tTEscanR_obj <- ComputeCodonUsage(object = tTEscanR_obj, species = "hg38", additional_metrics = FALSE)
  tTEscanR_obj <- Update_tTEscanR_Object(object = tTEscanR_obj, meta.data = list(default_tTEscanR_metadata, "FakeColumn"), meta.data.ids = list("ConditionsLabels", "CorrectionFactor"))
  ...
  tTEscanR_obj <- Update_tTEscanR_Object(object = tTEscanR_obj, meta.data = list(default_tTEscanR_metadata, "tissue"), meta.data.ids = list("ConditionsLabels", "CorrectionFactor"), overwrite = TRUE)
