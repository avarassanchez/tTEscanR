test_that("The different modes to compute the amino acid usage", {
  ...
  tTEobject <- Create_tTEscanR_Object(counts = list(default_tTEscanR_mRNA_data, default_tTEscanR_tRNA_data), assay = list("mRNA", "tRNA"),
  ...
  tTEobject <- Create_tTEscanR_Object(counts = default_tTEscanR_mRNA_data, assay = "mRNA", meta.data = list(default_tTEscanR_metadata, "tissue"),
